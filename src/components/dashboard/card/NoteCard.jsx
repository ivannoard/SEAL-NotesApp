...
const NoteCard = ({ modalData, modalDataId }) => {
        ...
        <div className="modal-dialog modal-dialog-centered modal-xl">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title fw-bold" id="exampleModalLabel">Detail Catatan</h4>
            ...
            <div className="modal-body">
              <form>
                <div className="mb-3">
                  ...
                  <input type="text" onChange={handleChange} className="form-control" name='judul' id="judul" aria-describedby="emailHelp" defaultValue={modalData.name} />
                </div>
                <div className='mb-2'>
